...
subprojects {
    ...
    dependencies {
        ...
        if (isCommon) {
            ...
            "modCompileOnly"(group = "vazkii.botania", name = "Botania-xplat", version = botaniaVersion) {
            ...
            "modImplementation"(group = "vazkii.botania", name = "Botania", version = "$botaniaVersion-${modLoader.uppercase(Locale.getDefault())}") {
                exclude(group = "dev.emi", module = "emi")
                exclude(group = "dev.emi", module = "emi-fabric")
            }
        }
    ...
    if (!isCommon) {
        ...
        tasks {
            "shadowJar"(ShadowJar::class) {
                ...
                exclude("**/create_botanics/datagen/**") // Remove data gen code from jar.
            }
    ...
    publishing {
        publications {
            create<MavenPublication>("maven") {
                ...
                pom {
                    name.set("CreateBotanics $modLoader")

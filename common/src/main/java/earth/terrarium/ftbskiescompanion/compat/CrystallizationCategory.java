...
import earth.terrarium.ftbskiescompanion.client.AnimatedLiquidCrystallizer;
...
public class CrystallizationCategory extends CreateRecipeCategory<CrystallizationRecipe> {
    ...
    public static final RecipeType<CrystallizationRecipe> RECIPE = new RecipeType<>(new ResourceLocation(FTBSkiesCompanion.MOD_ID, "crystallization"), CrystallizationRecipe.class);
